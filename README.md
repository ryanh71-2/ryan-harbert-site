...
In Cloudflare Pages, connect the GitHub repository, leave the build command blank, set the build output directory to `public`, and use the main branch for production. For proposed revisions, use a separate branch and Cloudflare's preview deployment, then merge after review.
